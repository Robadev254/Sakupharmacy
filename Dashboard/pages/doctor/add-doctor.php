    ...
    <body class="ms-body ms-aside-left-open ms-primary-theme ms-has-quickbar">
        ...
        <aside id="ms-side-nav" class="side-nav fixed ms-aside-scrollable ms-aside-left">
            ...
            <div class="logo-sn ms-d-block-lg">
                <a class="ps-0 ms-0 text-center" href="../../index.html"> <img src="/Logo/Saku-logo.jpg" alt="logo" width="50" height="50"> </a>
            ...
            <nav class="navbar ms-navbar">
              ...
              <div class="docfind-logo d-none d-xl-block">
                <a class="sigma_logo" href="../../../index.html">
                    <img src="/Logo/Saku-logo.jpg" alt="logo" width="40" height="40">
                </a>
              </div>
              ...
              <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
                <li class="ms-nav-item ms-nav-user dropdown">
                  <a href="#" id="userDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img class="ms-user-img ms-img-round float-end" src="" alt="people"> </a>
                  <ul class="dropdown-menu dropdown-menu-end user-dropdown" aria-labelledby="userDropdown">
                    <li class="dropdown-menu-header">
                      <h6 class="dropdown-header ms-inline m-0"><span class="text-disabled">Welcome, Dr Anthony</span></h6>
                    </li>
                    <li class="dropdown-divider"></li>
                    <li class="ms-dropdown-list">
                      <a class="media fs-14 p-2" href="/doc.php"> <span><i class="flaticon-user me-2"></i> Profile</span> </a>
                    </li>
                    <li class="dropdown-divider"></li>
                    <li class="dropdown-menu-footer">
                    <li class="dropdown-menu-footer">
                      <a class="media fs-14 p-2" href="/index.php"> <span><i class="flaticon-shut-down me-2"></i> Logout</span> </a>
                    </li>
                  </ul>
                </li>
              </ul>
                                ...
                                <form class="needs-validation" novalidate>
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="validationCustom0001" placeholder="Enter First Name"  required name="FirstName">
                                            </div>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="validationCustom0002">Last name</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="validationCustom0002" placeholder="Enter Last Name" required name="LastName">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="email" class="form-control" id="validationCustom0003" placeholder="Enter Email" required name="EmailAddress">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <div class="input-group">
                                                <input type="password" class="form-control" id="validationCustom0004" placeholder="Enter Password" required name="Password">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="validationCustom0005" placeholder="Enter Designation" required name="Designation">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control" id="validationCustom6" required name="Department">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="validationCustom007" placeholder="Address" required name="Address">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="validationCustom008" placeholder="Specialist" required name="Specialist">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="validationCustom009" placeholder="Mobile" required name="Mobile">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" id="validationCustom102" placeholder="Date of Birth"  required name="DOB">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control" id="validationCustom202" required name="BloodGroup">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <ul class="ms-list d-flex">
                                                <li class="ms-list-item ps-0">
                                                    ...
                                                    <input type="radio" name="radioExample" value="" name="Sex">

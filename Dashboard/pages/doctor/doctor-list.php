...
<head>
  ...
  <title>SAKU PHARMACY Dashboard</title>
  <!-- Iconic Fonts -->
    ...
    <ul class="accordion ms-main-aside fs-14" id="side-nav-accordion">
      ...
      <li class="menu-item">
        ...
        <ul id="patient" class="collapse" aria-labelledby="patient" data-bs-parent="#side-nav-accordion">
          <li> <a href="../patient/add-patient.php">Add Patient</a> </li>
          <li> <a href="../patient/patient-list.php">Patient List</a> </li>
        </ul>
      </li>
      <!-- /Patient -->
      <!-- Department -->
    ...
    <nav class="navbar ms-navbar">
      ...
      <div class="docfind-logo d-none d-xl-block">
                <a class="sigma_logo" href="../../../index.html">
                    <img src="/Logo/Saku-logo.jpg" alt="logo" width="50" height="50">
                </a>
              </div>
      ...
      <ul class="ms-nav-list ms-inline mb-0" id="ms-nav-options">
        ...
        <li class="ms-nav-item ms-nav-user dropdown">
          <a href="#" id="userDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <img class="ms-user-img ms-img-round float-end" src="" alt="Anthony "> </a>
            ...
            <div class="ms-card-body">
              <div class="media fs-14">
                <div class="me-2 align-self-center">
                  <img src="" class="ms-img-round" alt="Mikey">
                </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
          <div class="ms-card">
            <div class="ms-card-body">
              <div class="media fs-14">
                <div class="me-2 align-self-center">
                  <img src="" class="ms-img-round" alt="Linda">
                </div>
                <div class="media-body">
                  <h6>Linda Omari</h6>
                  <div class="dropdown float-end">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
          <div class="ms-card">
            <div class="ms-card-body">
              <div class="media fs-14">
                <div class="me-2 align-self-center">
                  <img src="" class="ms-img-round" alt="Jacob">
                </div>
                <div class="media-body">
                  <h6>Jacob Mutinda</h6>
                  <div class="dropdown float-end">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
          <div class="ms-card">
            <div class="ms-card-body">
              <div class="media fs-14">
                <div class="me-2 align-self-center">
                  <img src="" class="ms-img-round" alt="Paul">
                </div>
                <div class="media-body">
                  <h6>Paul Waithaka </h6>
                  <div class="dropdown float-end">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
          <div class="ms-card">
            <div class="ms-card-body">
              <div class="media fs-14">
                <div class="me-2 align-self-center">
                  <img src="" class="ms-img-round" alt="Marion">
                </div>
                <div class="media-body">
                  <h6>Marion Christine</h6>
                  <div class="dropdown float-end">
                    <a href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i class="material-icons">more_vert</i>
                    </a>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
          <div class="ms-card">
            <div class="ms-card-body">
              <div class="media fs-14">
                <div class="me-2 align-self-center">
                  <img src="" class="ms-img-round" alt="Sebastian">
                </div>
                <div class="media-body">
                  <h6>Sebastan Wanjala</h6>
                  <div class="dropdown float-end">
                    <a href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                      <i class="material-icons">more_vert</i>
                    </a>
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
          <div class="ms-card">
            <div class="ms-card-body">
              <div class="media fs-14">
                <div class="me-2 align-self-center">
                  <img src="" class="ms-img-round" alt="William">
                </div>
                <div class="media-body">
                  <h6>Maggy William</h6>
                  <div class="dropdown float-end">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
          <div class="ms-card">
            <div class="ms-card-body">
              <div class="media fs-14">
                <div class="me-2 align-self-center">
                  <img src="" class="ms-img-round" alt="people">
                </div>
                <div class="media-body">
                  <h6>Diana Eunice</h6>
                  <div class="dropdown float-end">
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
          <div class="ms-card">
            <div class="ms-card-body">
              <div class="media fs-14">
                <div class="me-2 align-self-center">
                  <img src="" class="ms-img-round" alt="Chacha">
                </div>
                <div class="media-body">
                  <h6>Chacha Albert</h6>
                  <div class="dropdown float-end">
              ...
              <div class="ms-chat-container">
                <div class="ms-chat-header px-3">
                  <div class="ms-chat-user-container media clearfix">
                    <div class="ms-chat-status ms-status-online ms-chat-img me-3 align-self-center">
                      <img src="" class="ms-img-round" alt="people">
                    </div>
                    <div class="media-body ms-chat-user-info mt-1">
                      <h6>Dr. Anthony</h6>
                      <a href="#" class="text-disabled has-chevron fs-12" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Available
                      </a>

...
if($_SERVER['REQUEST METHOD']=="POST"){
  ...
  if(!empty($user_name) && !empty($Pass) && !is_numeric($user_name)){{
    $query = "insert into patients (user_name, pass) values($user_name, $pass)";
  }
...
$Your_Pass = $conn->real_escape_string($_POST['Your_Pass']);

$sql = "SELECT * FROM patients WHERE Your_Email = '$Your_Email' AND Pass = '$Pass'";
...
<head>
  ...
  <link rel="icon" href="/Assets/patient.png">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade in" id="login">
            ...
            <form id="login" action="user.php" method="POST">
              <div class="form-group">
                <label> Your Email<span class="req">*</span> </label>
                <input type="email" class="form-control" id="email" required data-validation-required-message="Please enter your email address." autocomplete="off" name="Your_Email">
                <p class="help-block text-danger"></p>
              </div>
              <div class="form-group">
                <label> Password<span class="req">*</span> </label>
                <input type="password" class="form-control" id="password" required data-validation-required-message="Please enter your password" autocomplete="off" name="Pass">
                <p class="help-block text-danger"></p>
              </div>
              <div class="mrgn-30-top">
                <button type="submit" class="btn btn-larger btn-block">
                ...
                <button type="submit" class="btn btn-larger btn-block">
                <a href="/doc.html">PHARMACIST LOGIN</a>
                </button>
